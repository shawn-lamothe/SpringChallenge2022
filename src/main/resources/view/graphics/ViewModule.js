...
import { EFFECT_HIT, HIT_FRAMES, EFFECT_SHIELD, EFFECT_BEAM, EFFECT_GUST, EFFECT_GLINT, DISC_RADIUS, GLINT_FRAMES, BEAM_FRAMES, GUST_FRAMES, SHIELD_FRAMES, HERO_FRAMES, MOB_1_FRAMES, MOB_2_FRAMES, MOB_3_FRAMES, HERO_ANCHOR_RUN, HERO_ANCHOR_STAND, HERO_ANCHOR_CAST, FOG_SCALE, HERO_ANCHOR_COMBAT, LIFE_FRAMES, MOB_DEATH_FRAMES, PENTAGRAM_ANIMATION_PAD, PENTAGRAM_ANIMATION_SCALE } from './assetConstants.js';
...
export class ViewModule {
    ...
    unconvertPosition(pos) {
        var _a;
        const padding = (_a = this.padding) !== null && _a !== void 0 ? _a : { top: 0, left: 0, right: 0, bottom: 0 };
        return {
    ...
    _handleFrameData(frameInfo, { positions, spawns, attacks, baseAttacks, spellUses, mana, mobHealth, baseHealth, messages, controlled, pushed, shielded }) {
        ...
        const state = {
            ...
            pushed,
            shielded,
            mana: Object.assign(Object.assign({}, previous.mana), mana),
            mobHealth: Object.assign(Object.assign({}, previous.mobHealth), mobHealth),
            baseHealth: Object.assign(Object.assign({}, previous.baseHealth), baseHealth),
            spellUses,
            messages,
            previous
        };
    ...
    isDebugMode() {
        var _a;
        return ((_a = this.globalData) === null || _a === void 0 ? void 0 : _a.demo) ? false : api.options.debugMode;
    }
    ...
    initFog(layer) {
        ...
        const cloudLayer = this.asLayer((layer) => {
            const fog = PIXI.TilingSprite.from('fog_alpha', { width: WIDTH, height: HEIGHT });
            fog.alpha = 0.55;
            fog.tint = 0xEDEDED;
    ...
    initPlayerHud(index) {
        ...
        return (layer) => {
            ...
            for (let i = 0; i < 3; ++i) {
                ...
                heart.textures.push(PIXI.Texture.EMPTY);
                heart.loop = false;
    ...
    initMob(id, entityData) {
        ...
        const life = this.asLayer(this.initLifeBar(entityData));
        const debug = this.asLayer(this.initDebugEntity(entityData));
